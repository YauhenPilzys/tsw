# Generated by Django 4.1.13 on 2025-01-29 14:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='EClient',
            fields=[
                ('ideclient', models.AutoField(primary_key=True, serialize=False)),
                ('regN_TS', models.CharField(max_length=255)),
                ('regN_DOK', models.CharField(max_length=255)),
                ('countKod', models.IntegerField()),
                ('guidXML', models.CharField(max_length=255)),
                ('lc', models.CharField(max_length=255)),
                ('id_z', models.IntegerField()),
                ('tip', models.CharField(max_length=255)),
                ('status', models.CharField(max_length=255)),
                ('regID', models.CharField(max_length=255)),
                ('numbEPI', models.CharField(max_length=255)),
                ('statID', models.CharField(max_length=255)),
                ('postIN', models.CharField(max_length=255)),
                ('razr', models.CharField(max_length=255)),
                ('id_xmlf', models.IntegerField()),
            ],
            options={
                'db_table': 'eclient',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unp', models.CharField(default='591489147', editable=False, max_length=15, verbose_name='УНП компании')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_order', models.CharField(choices=[('0', 'создан'), ('1', 'в работе'), ('2', 'ошибка при отправке'), ('3', 'отправлен'), ('4', 'закрыт')], default='0', max_length=2, verbose_name='Статус заказа')),
                ('datetime', models.DateTimeField(verbose_name='Дата и время заказа')),
                ('quantity', models.PositiveIntegerField(verbose_name='Количество партий')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('create', 'Создание'), ('update', 'Обновление'), ('delete', 'Удаление'), ('close', 'Закрытие')], max_length=20, verbose_name='Действие')),
                ('action_user', models.CharField(blank=True, max_length=255, null=True, verbose_name='Описание действия пользователя')),
        ...
        migrations.AddField(
            model_name='order',
            name='supplier',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.supplier', verbose_name='Отправитель / Получатель'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
        ...
        migrations.AddField(
            model_name='notice',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='notices', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь'),
        ),
        migrations.CreateModel(
            name='LogPlace',
            fields=[
        ...
        migrations.AddField(
            model_name='logbook',
            name='user_in',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='registered_by_log', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь создал запись'),
        ),
        migrations.AddField(
            model_name='logbook',
            name='user_out',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='removed_by_log', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь закрыл запись'),
        ),
        migrations.AddField(
            model_name='logbook',
            name='warehouse',
